...
## **So what format should we follow? As organized by our PO and Lead Dev we have a few choices for things.**
...
1. When submitting a comment for a pull request, it's possible to label your pull request as a solution to another issue. For example, reference the below image, and what I have put into the comment that will resolve our number 12 issue of no .idea file that's ignored in our .gitignore file.
